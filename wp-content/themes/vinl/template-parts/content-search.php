...
<?php $counter = $args['counter']; ?>

<?php
$show_hide_image = get_theme_mod('post_snippet_hide_show_featured_image', finley_get_default_post_snippet_featured_image());
$show_hide_date = get_theme_mod('post_snippet_hide_show_date', finley_get_default_post_snippet_date());
$show_hide_author = get_theme_mod('post_snippet_hide_show_author', finley_get_default_post_snippet_author());
$show_hide_comment = get_theme_mod('post_snippet_hide_show_comment', finley_get_default_post_snippet_comment());
$show_hide_categories = get_theme_mod('post_snippet_hide_show_category', finley_get_default_post_snippet_category());
$show_hide_tags = get_theme_mod('post_snippet_hide_show_tag', finley_get_default_post_snippet_tag());
$show_hide_social_share = get_theme_mod('post_snippet_hide_show_social_share', finley_get_default_post_snippet_social_share());
$social_share = get_theme_mod('post_snippet_social_share_options', finley_get_default_post_snippet_social_share_options());
?>
