...
add_action('customize_register', 'finley_register_post_snippet_customization_section');
function finley_register_post_snippet_customization_section($wp_customize)
{

	$wp_customize->add_section('finley_post_snippet_customization_section', array(
		'title'	=> esc_html__('Post Snippet', 'finley'),
		'priority'	=> 22
	));
}
