...
add_action('customize_register', 'finley_post_snippet_comment');
function finley_post_snippet_comment($wp_customize)
{

    $wp_customize->add_setting('post_snippet_hide_show_comment', array(
        'sanitize_callback'     =>  'finley_sanitize_checkbox',
        'default'               =>  finley_get_default_post_snippet_comment()
    ));
