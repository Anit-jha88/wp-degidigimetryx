...
add_action('customize_register', 'finley_register_font_customization_section');
function finley_register_font_customization_section($wp_customize)
{

	$wp_customize->add_section('finley_font_customization_section', array(
		'title'	=> esc_html__('Font Options', 'finley'),
		'priority'	=> 20
	));
}
