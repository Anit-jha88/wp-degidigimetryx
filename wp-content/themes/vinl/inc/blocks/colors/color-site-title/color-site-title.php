...
add_action('customize_register', 'finley_site_title_color');
function finley_site_title_color($wp_customize)
{

	$wp_customize->add_setting('site_title_color_option', array(
		'default'     => finley_get_default_site_title_color(),
		'transport' => 'postMessage',
		'sanitize_callback' => 'sanitize_hex_color',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'site_title_color_option', array(
		'label'      => esc_html__('Site Identity Color', 'finley'),
...
add_action('customize_preview_init', 'finley_site_title_color_enqueue_scripts');
function finley_site_title_color_enqueue_scripts()
{
