...
add_action('wp_enqueue_scripts', 'finley_google_fonts_scripts');
function finley_google_fonts_scripts()
{
    $args = finley_used_google_fonts();
    wp_enqueue_style('google-fonts', finley_fonts_url($args), array(), null);
}
