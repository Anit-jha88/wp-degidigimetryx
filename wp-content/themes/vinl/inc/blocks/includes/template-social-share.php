<script type="text/javascript">
	var fb = '<?php echo esc_html__("Facebook", 'finley'); ?>';
	var twitter = '<?php echo esc_html__("Twitter", 'finley'); ?>';
	var pinterest = '<?php echo esc_html__("Pinterest", 'finley'); ?>';
	var linkedin = '<?php echo esc_html__("Linkedin", 'finley'); ?>';
</script>
...
<ul class="list-inline">
	...
	<li><?php esc_html_e("Share", 'finley'); ?>:</li>
