...
//                                endif;
        ...
        function register_submenus() {
            ...
            add_submenu_page(
                    TGDPRCL_DOMAIN, __('More WP Resources', TGDPRCL_DOMAIN), __('More WP Resources', TGDPRCL_DOMAIN), 'manage_options', 'tgdprcl-more-wp-resources', array($this, 'tgdprc_more_wordpress_resources')
            );
        }
         ...
         * This is a function for choosing a Cookie info to activate into the Plugin
         */
        function tgdprc_more_wordpress_resources() {
            $title = __('More WordPress Resources', TGDPRCL_DOMAIN);
            include_once TGDPRCL_PATH . 'inc/backend/more-wordpress-resources.php';
        }
        ...
        function tgdprcl_define_some_constants() {
            ...
            defined('TGDPRCL_VERSION') or define('TGDPRCL_VERSION', '1.0.1');
