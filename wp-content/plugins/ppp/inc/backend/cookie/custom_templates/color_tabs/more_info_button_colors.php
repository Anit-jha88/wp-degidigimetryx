...
<div class="tgdprc_color_customizations" id="tgdprc_more_info_button_colors_tab" style="display: none;">
    ...
    <div class="tgdprc_design_settings_field tgdprc_icon_type_field" id="tgdprc_icon_type_default">
        ...
        <input class="tgdprc-icon-picker" type="hidden" id="tgdprc-more-info-icon-picker" name="custom_template[more_info_icon]" data-field-name="menu_id" value="<?php echo (!empty($custom_template['more_info_icon'])) ? ($custom_template['more_info_icon']) : 'fa|fa-lightbulb-o'; ?>"/>
