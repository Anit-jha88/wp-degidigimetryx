...
<div class="tgdprc_container">
    ...
    <?php if (isset($_GET['message']) && $_GET['message'] == 1): ?>
        <?php if (isset($_GET['template_message']) && $_GET['template_message'] == 'notadded'): ?>
            <div class="notice notice-error is-dismissible"><p><?php esc_attr_e('Adding Template Failed', TGDPRCL_DOMAIN) ?></p></div>
        <?php endif ?>
    <?php endif ?>
    ...
    <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" class="tgdprc_custom_template_form">
        ...
        <button class="tgdprc-save-custom-setting-button button button-primary" type="submit"><?php esc_attr_e('Add', TGDPRCL_DOMAIN) ?></button>
