...
?>
<div class="tgdprc-cookie-bar-display tgdprc_cookie_notice_<?= esc_attr($display_settings['layout']['display_type']) ?> <?php echo $display_class; ?> <?php echo ($display_settings['layout']['select_template_type'] == 'custom') ? esc_attr('tgdprc_cookie_notice_custom-temp') : ''; ?>" id="tgdprc_cookie_bar_main_display" data-type="<?php echo esc_attr($display_settings['layout']['display_type']) ?>" style="display: none;">

    <div class="tgdprc-cookie-bar-body <?php echo $body_class; ?> <?= ((($display_settings['layout']['display_type'] == 'popup') && (!isset($general_settings['content']['more_info']['status']))) || (($template == 'Template-20') && !isset($general_settings['content']['more_info']['status']))) ? esc_attr('wpcui_more_info_nf') : '' ?>" id="tgdprc_cookie_bar_main_body">
